...
(function ($) {
  jQuery(document).ready(function () {
    ...
    detectDevice(); // ======= Adjust height of the post cards =============

    function adjustPostCardsHeight() {
      if (!isMobile) {
        // no need to adjust height for mobile devices
        var postCardHolder = document.getElementById("post-cards");

        if (postCardHolder == null) {
          return;
        }

        var el = postCardHolder.children;
        var maxHeight = 0;
        ...
        for (var _i = 0; _i < el.length; _i++) {
          el[_i].children[1].setAttribute("style", "min-height: " + maxHeight + "px;");
        }
      }
    }

    adjustPostCardsHeight(); // ============= Sidebar Tree ================

    function buildSidebarMenu() {
      var openedClass = "icon-minus-circled";
      var closedClass = "icon-plus-circled"; // initialize top level

      var tree = $("#tree"); // add expand icon to those li who has ul as children
    ...
    buildSidebarMenu(); // initialize filterizr

    filterizd = $(".filtr-container").filterizr({
      layout: 'sameWidth'
    });
  });
})(jQuery); // toggle sidebar on click


window.toggleSidebar = function () {
  document.getElementById("sidebar").classList.toggle("hide");
  document.getElementById("content").classList.toggle("overley"); // if it is mobile device. then scroll to top.
